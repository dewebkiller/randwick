...
class WooCommerceGermanized extends Core {
	...
	public function run_immediately() {
		add_action( 'cartimize_checkout_before_payment_method_tab_nav', 'woocommerce_gzd_template_render_checkout_checkboxes' );
		add_action( 'cartimize_checkout_before_payment_method_tab_nav', 'woocommerce_gzd_template_checkout_set_terms_manually' );
